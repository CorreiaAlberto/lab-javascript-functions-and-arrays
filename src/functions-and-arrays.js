...
function averageNumbers(arrayNumbers) {
  ...
  let average = sumNumbers(arrayNumbers) / arrayNumbers.length;
  return average;
}
...
function averageWordLength(wordsArray) {
  ...
  let average = sum(wordsArr[i].length) / wordsArray.length;
  return average;
}
...
function avg(mixArray) {
  ...
  let average = sum(mixArray.length) / mixArray.length;
  return average;
}
